...
def protocol_version_from_evidence(evidence: EvidenceRecord) -> str | None:
    """Read the Protocol version carried by an observed transition."""
...
def replay_with_historical_protocol_versions(
    ...
    """Replay Evidence while preserving historical versions separately from current ones."""
    ...
    return {
        ...
        "protocol_version_lineage": tuple(lineage),
    }
